...
#import "exportphotosAppDelegate.h"
#import "ExportPhotoViewController.h"

@implementation exportphotosAppDelegate
...
- (ExportPhotoViewController *)controller {
    if ( ! _controller) {
        _controller = [[ExportPhotoViewController alloc] initWithNibName:@"ExportPhotoViewController" bundle:nil];
    }
    return _controller;
}
