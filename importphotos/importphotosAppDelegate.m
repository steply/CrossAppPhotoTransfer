...
#import "importphotosAppDelegate.h"
#import "ImportPhotosViewController.h"

@implementation importphotosAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _controller = [[ImportPhotosViewController alloc] initWithNibName:@"ImportPhotosViewController" bundle:nil];
